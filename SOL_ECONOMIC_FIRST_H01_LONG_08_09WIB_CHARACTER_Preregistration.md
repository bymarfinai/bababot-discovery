# SOL Economic-First H01 — One-Hour LONG Character Discovery

## Scientific question

Within one fixed SOL time habitat only — **01:00–02:00 UTC / 08:00–09:00 WIB** — what causal pre-entry character produces robust high-WR positive LONG economics?

This hour is independent of H00. It does not inherit the H00 descriptive clue, the frozen `R360 / 15UTC / E0_RESTING_H -> E40` parent, Fibonacci coordinates, visit-order structure, entry geometry, target, recovery rule, or loss taxonomy from the earlier SOL lineage.
...
- Weekdays only.
- Direction: **LONG only**.
- Anchors: **01:00, 01:15, 01:30, 01:45 UTC** = 08:00, 08:15, 08:30, 08:45 WIB.
...
- If at least one candidate passes, select exactly the top frozen-ranked candidate and mark `SOL_ECONOMIC_FIRST_H01_LONG_CHARACTER_FOUND`.
- Otherwise mark `SOL_ECONOMIC_FIRST_H01_NO_LONG_CHARACTER`.
