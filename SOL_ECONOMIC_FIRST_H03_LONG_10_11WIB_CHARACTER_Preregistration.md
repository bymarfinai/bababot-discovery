# SOL Economic-First H03 — One-Hour LONG Character Discovery

## Scientific question

Within one fixed SOL time habitat only — **03:00–04:00 UTC / 10:00–11:00 WIB** — what causal pre-entry character produces robust high-WR positive LONG economics?

This hour is independent of H00–H02. It does not inherit any earlier descriptive clue, the frozen `R360 / 15UTC / E0_RESTING_H -> E40` parent, Fibonacci coordinates, visit-order structure, entry geometry, target, recovery rule, or loss taxonomy.
...
- Weekdays only.
- Direction: **LONG only**.
- Anchors: **03:00, 03:15, 03:30, 03:45 UTC** = 10:00, 10:15, 10:30, 10:45 WIB.
...
- If at least one candidate passes, select exactly the top frozen-ranked candidate and mark `SOL_ECONOMIC_FIRST_H03_LONG_CHARACTER_FOUND`.
- Otherwise mark `SOL_ECONOMIC_FIRST_H03_NO_LONG_CHARACTER`.
