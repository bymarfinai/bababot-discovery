# B27DS — BTC F85 LONG + F15 SHORT Collision / Portfolio Interference Audit — Preregistration
...
No F15/F65/E20_DOWN, confirmation, timeframe, reference duration, execution duration, fee, sizing, regime, or candle filter may change in B27DS.
...
- SHORT exit timestamp is reconstructed from persisted B27DR `entry_start + fixed_hold_minutes`.
...
- Do not optimize the SHORT clock set after B27DS results.
