...
- Development H2 F95 entries used for thresholds: **20**
- `PATH_P75` (pre-entry max depth): **0.3558R**
- `RECLAIM_LOW_P75` (reclaim-candle low depth): **0.1780R**
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| RAW_F95_EXTERNAL | 18 | 15 | 83.3% | 60.8% – 94.2% | 33.3% | 37.5m | 5.0m | 0.0391R | 0.0000R | 0.1491R |
| CLEAN_F95_EXTERNAL | 10 | 8 | 80.0% | 49.0% – 94.3% | 17.8% | 15.0m | 5.0m | 0.0382R | 0.0000R | 0.2397R |

## Preregistered support contract

- Clean retention: **55.6%** (10/18)
- Delta H2 rate: **-3.3 percentage points**
...
**Status: B27ER_BNB_CLEAN_F95_EXTERNAL_NOT_SUPPORTED**
