...
Source coverage: 100.0000%. Grid: 90 rules × 20 coarse timings = **1800 cells**.
Development-eligible cells under the preregistered practical-stability protocol: **18**.
Maximum loss streak is diagnostic only and is not an eligibility gate.

## Frozen Development representative

Rule: **DRIVE_DOWN__STR_B40_60**
Timing: **LB240 / H480**
N **86**, WR **62.79%**, Net **$+353.86**, Exp **$+4.11**, PF **2.510**, DD **$82.29**, LS **6**.
2022 H1 Exp $+5.42/PF 3.515; H2 Exp $+3.26/PF 2.053; positive anchors 4/4.
