# B27FC — BNB Hour-by-Hour Structural Discovery: 02:00 WIB

Status: PREREGISTERED BEFORE RESULT REVEAL

## Intent
Continue the one-clock-at-a-time BNB structural search. B27FC evaluates only the 02:00 WIB anchor using the exact same structural template as B27FA/B27FB so the clocks can be compared apples-to-apples. This milestone does not define or test an entry, TP, SL, PnL, repair mechanism, or live rule.
...
- reference window: 02:00 <= t < 06:00 WIB
- execution window: 06:00 <= t < 10:00 WIB
...
Use the exact causal B27EM/B27FA/B27FB K1/leave/H2 logic.
...
The current structural leader before B27FC reveal is 01:00 WIB.
...
## Stop rule
B27FC stops after the 02:00 WIB structural result is persisted. Do not test 03:00 WIB, do not invent an entry, and do not reveal holdout partitions in this milestone.
