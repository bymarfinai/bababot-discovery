# SOL Economic-First H02 — One-Hour LONG Character Discovery

## Scientific question

Within one fixed SOL time habitat only — **02:00–03:00 UTC / 09:00–10:00 WIB** — what causal pre-entry character produces robust high-WR positive LONG economics?

This hour is independent of H00 and H01. It does not inherit either hour's descriptive clues, the frozen `R360 / 15UTC / E0_RESTING_H -> E40` parent, Fibonacci coordinates, visit-order structure, entry geometry, target, recovery rule, or loss taxonomy from the earlier SOL lineage.
...
- Weekdays only.
- Direction: **LONG only**.
- Anchors: **02:00, 02:15, 02:30, 02:45 UTC** = 09:00, 09:15, 09:30, 09:45 WIB.
...
- If at least one candidate passes, select exactly the top frozen-ranked candidate and mark `SOL_ECONOMIC_FIRST_H02_LONG_CHARACTER_FOUND`.
- Otherwise mark `SOL_ECONOMIC_FIRST_H02_NO_LONG_CHARACTER`.
