# B27CT — BTC 24H SHORT Clock × Regime EMA Filter Anatomy — Preregistration
...
B27CT is **anatomy/filter research only**. It does not optimize SL, runner, entry price, target depth, regime definitions, or clock inclusion. Trading WR/PF/expectancy/PnL are N/A.
...
`B27CT_CLOCK_REGIME_EMA_REUSED_CANDIDATE` requires:
1. audit PASS;
...
Otherwise verdict: `B27CT_CLOCK_REGIME_EMA_NOT_SUPPORTED`.
