# B27FF — BNB Hour-by-Hour Structural Discovery: 05:00 WIB

Status: PREREGISTERED BEFORE RESULT REVEAL

## Intent
Continue the one-clock-at-a-time BNB structural search. B27FF evaluates only the 05:00 WIB anchor using the exact same structural template as B27FA–B27FE so clocks remain directly comparable. This milestone does not define or test an entry, TP, SL, PnL, repair mechanism, or live rule.
...
- reference window: 05:00 <= t < 09:00 WIB
- execution window: 09:00 <= t < 13:00 WIB
...
Use the exact causal B27EM/B27FA–B27FE K1/leave/H2 logic.
...
The current structural leader before B27FF reveal is 01:00 WIB.
...
## Stop rule
B27FF stops after the 05:00 WIB structural result is persisted. Do not test 06:00 WIB, do not invent an entry, and do not reveal holdout partitions in this milestone.
