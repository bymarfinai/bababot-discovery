# SOL Economic-First H04 — One-Hour LONG Character Discovery

## Scientific question

Within one fixed SOL time habitat only — **04:00–05:00 UTC / 11:00–12:00 WIB** — what causal pre-entry character produces robust high-WR positive LONG economics?

This hour is independent of H00–H03. It does not inherit any earlier descriptive clue, the frozen `R360 / 15UTC / E0_RESTING_H -> E40` parent, Fibonacci coordinates, visit-order structure, entry geometry, target, recovery rule, or loss taxonomy.
...
- Weekdays only.
- Direction: **LONG only**.
- Anchors: **04:00, 04:15, 04:30, 04:45 UTC** = 11:00, 11:15, 11:30, 11:45 WIB.
...
- If at least one candidate passes, select exactly the top frozen-ranked candidate and mark `SOL_ECONOMIC_FIRST_H04_LONG_CHARACTER_FOUND`.
- Otherwise mark `SOL_ECONOMIC_FIRST_H04_NO_LONG_CHARACTER`.
