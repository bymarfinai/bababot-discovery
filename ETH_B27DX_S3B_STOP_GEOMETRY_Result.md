...
## Supported stop-family runs

- Run 1: **F45** (1 adjacent stops).
- Run 2: **F35** (1 adjacent stops).
- Run 3: **F20** (1 adjacent stops).

## BTC benchmark diagnostic

- BTC B27DX LONG final: WR 71.9%, PF 2.22, expectancy +$1.26/trade.
- Stop-family promotion is topology-based; benchmark is diagnostic.

## Decision

**Status: ETH_S3B_SUPPORTED_STOPS_NO_FAMILY**
