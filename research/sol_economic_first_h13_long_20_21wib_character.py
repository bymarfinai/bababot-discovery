#!/usr/bin/env python3
"""Preregistered H13 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H13_LONG_20_21WIB_CHARACTER"

engine.CLOCKS = (780, 795, 810, 825)
engine.PFX = PFX
...
def relabel_outputs() -> None:
    ...
    for old, new in (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H13 — 20:00–21:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "13:00–14:00 UTC / 20:00–21:00 WIB"),
        ("07:00–08:00 WIB", "20:00–21:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H13_"),
    ):
        result = result.replace(old, new)
    engine.OUT_RESULT.write_text(result)
    engine.OUT_STATUS.write_text(
        engine.OUT_STATUS.read_text().replace("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H13_")
    )
