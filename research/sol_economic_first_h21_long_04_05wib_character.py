#!/usr/bin/env python3
"""Preregistered H21 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H21_LONG_04_05WIB_CHARACTER"

engine.CLOCKS = (1260, 1275, 1290, 1305)
engine.PFX = PFX
...
def relabel_outputs() -> None:
    ...
    for old, new in (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H21 — 04:00–05:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "21:00–22:00 UTC / 04:00–05:00 WIB"),
        ("07:00–08:00 WIB", "04:00–05:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H21_"),
    ):
        result = result.replace(old, new)
    engine.OUT_RESULT.write_text(result)
    engine.OUT_STATUS.write_text(
        engine.OUT_STATUS.read_text().replace("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H21_")
    )
