# DOGE D1K — 23:00–00:00 WIB LONG Character Discovery Preregistration

## Purpose
Continue the mandatory DOGEUSDT pair-native 24-hour LONG character sweep by testing exactly one new clock habitat: **23:00–00:00 WIB**.

## Frozen scope
- Pair: **DOGEUSDT**
- Direction: **LONG only**
- Development only; **OOS remains closed**
- Clock anchors only: **23:00, 23:15, 23:30, 23:45 WIB** = **16:00, 16:15, 16:30, 16:45 UTC**
- Same frozen pair-agnostic causal grammar used in D1A–D1J
- Character rules: **90**
...
## Integrity lock
D1A–D1J results are comparison context only. Their winning or near-miss rules, lookbacks, holds, volatility states, range states, or payoff horizons **must not seed or restrict D1K ranking**. D1K must evaluate the complete frozen 3,240-candidate grid independently.

No gate relaxation, post-result rescue, OOS exposure, TP/SL tuning, SHORT mixing, or execution-stage optimization is allowed.

## D1 → D2 reset policy
D1K is **not** a restart. The current D1 temporal atlas must continue unchanged through **D1X** so the 24-hour map is complete.
