...
PFX = "BNB_ECONOMIC_FIRST_B28O_LONG_14_15WIB_CHARACTER"
...
def main():
    ...
    lines = [
        "# BNB Economic-First B28O — 14:00–15:00 WIB LONG Character Discovery Result", "",
        f"Raw BNBUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **14:00–15:00 WIB only** (07:00, 07:15, 07:30, 07:45 UTC anchors).",
        "Methodology and gates: **identical to preregistered B28A–B28N; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "BNB_ECONOMIC_FIRST_B28O_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 14:00–15:00 WIB BNB LONG character passed the preregistered anchor-stability + pooled-economics/risk + all-era gates.",
                  "No gate relaxation, prior-hour rescue, B27 structural rescue, or OOS exposure is allowed.",
                  "Next preregistered habitat: **15:00–16:00 WIB** with the unchanged methodology.", "", "Research/shadow only."]
    ...
    status = "BNB_ECONOMIC_FIRST_B28O_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
