#!/usr/bin/env python3
"""Preregistered H07 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H07_LONG_14_15WIB_CHARACTER"
...
def relabel_outputs() -> None:
    ...
    for old, new in (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H07 — 14:00–15:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "07:00–08:00 UTC / 14:00–15:00 WIB"),
        ("07:00–08:00 WIB", "14:00–15:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H07_"),
    ):
        result = result.replace(old, new)
    engine.OUT_RESULT.write_text(result)
    engine.OUT_STATUS.write_text(
        engine.OUT_STATUS.read_text().replace("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H07_")
    )
