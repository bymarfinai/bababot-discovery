...
PFX = "ETH_ECONOMIC_FIRST_E12F_LONG_18_19WIB_CHARACTER"
...
CLOCKS = (660, 675, 690, 705)  # 11:00..11:45 UTC = 18:00..18:45 WIB
...
def main():
    ...
    lines = [
        "# ETH Economic-First E12F — 18:00–19:00 WIB LONG Character Discovery Result", "",
        f"Raw ETHUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **18:00–19:00 WIB only** (11:00, 11:15, 11:30, 11:45 UTC anchors).",
        "Scientific grammar and gates: **identical to preregistered E12A–E12E; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "ETH_ECONOMIC_FIRST_E12F_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 18:00–19:00 WIB LONG character passed the preregistered anchor-stability + pooled-economics + all-era gates.",
    ...
    status = "ETH_ECONOMIC_FIRST_E12F_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
