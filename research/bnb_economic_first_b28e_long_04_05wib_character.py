...
PFX = "BNB_ECONOMIC_FIRST_B28E_LONG_04_05WIB_CHARACTER"
...
CLOCKS = (1260, 1275, 1290, 1305)  # 21:00..21:45 UTC = 04:00..04:45 WIB
...
def main():
    ...
    lines = [
        "# BNB Economic-First B28E — 04:00–05:00 WIB LONG Character Discovery Result", "",
        f"Raw BNBUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **04:00–05:00 WIB only** (21:00, 21:15, 21:30, 21:45 UTC anchors).",
        "Methodology and gates: **identical to preregistered B28A–B28D; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "BNB_ECONOMIC_FIRST_B28E_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 04:00–05:00 WIB BNB LONG character passed the preregistered anchor-stability + pooled-economics/risk + all-era gates.",
                  "No gate relaxation, prior-hour rescue, B27 structural rescue, or OOS exposure is allowed.",
                  "Next preregistered habitat: **05:00–06:00 WIB** with the unchanged methodology.", "", "Research/shadow only."]
    ...
    status = "BNB_ECONOMIC_FIRST_B28E_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
