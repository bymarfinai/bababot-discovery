...
PFX = "ETH_ECONOMIC_FIRST_E12M_LONG_01_02WIB_CHARACTER"
...
CLOCKS = (1080, 1095, 1110, 1125)  # 18:00..18:45 UTC = 01:00..01:45 WIB
...
def main():
    ...
    lines = [
        "# ETH Economic-First E12M — 01:00–02:00 WIB LONG Character Discovery Result", "",
        f"Raw ETHUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **01:00–02:00 WIB only** (18:00, 18:15, 18:30, 18:45 UTC anchors).",
        "Scientific grammar and gates: **identical to preregistered E12A–E12L; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "ETH_ECONOMIC_FIRST_E12M_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "", "No 01:00–02:00 WIB LONG character passed the preregistered anchor-stability + pooled-economics + all-era gates.", "No gate relaxation and no OOS exposure.", "", "Research/shadow only."]
    ...
    status = "ETH_ECONOMIC_FIRST_E12M_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
