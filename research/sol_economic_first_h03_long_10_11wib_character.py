#!/usr/bin/env python3
"""Preregistered H03 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H03_LONG_10_11WIB_CHARACTER"

# H03 is an independent one-hour habitat. Only the clock and output namespace
# differ from H00; candidate grammar, normalization, economics, and gates stay frozen.
engine.CLOCKS = (180, 195, 210, 225)
engine.PFX = PFX
...
def relabel_h03_outputs() -> None:
    result = engine.OUT_RESULT.read_text()
    replacements = (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H03 — 10:00–11:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "03:00–04:00 UTC / 10:00–11:00 WIB"),
        ("07:00–08:00 WIB", "10:00–11:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H03_"),
    )
