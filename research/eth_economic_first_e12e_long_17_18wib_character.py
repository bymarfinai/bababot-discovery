...
PFX = "ETH_ECONOMIC_FIRST_E12E_LONG_17_18WIB_CHARACTER"
...
CLOCKS = (600, 615, 630, 645)  # 10:00..10:45 UTC = 17:00..17:45 WIB
...
def main():
    ...
    lines = [
        "# ETH Economic-First E12E — 17:00–18:00 WIB LONG Character Discovery Result", "",
        f"Raw ETHUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **17:00–18:00 WIB only** (10:00, 10:15, 10:30, 10:45 UTC anchors).",
        "Scientific grammar and gates: **identical to preregistered E12A–E12D; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "ETH_ECONOMIC_FIRST_E12E_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 17:00–18:00 WIB LONG character passed the preregistered anchor-stability + pooled-economics + all-era gates.",
    ...
    status = "ETH_ECONOMIC_FIRST_E12E_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
