...
PFX = "ETH_ECONOMIC_FIRST_E12G_LONG_19_20WIB_CHARACTER"
...
CLOCKS = (720, 735, 750, 765)  # 12:00..12:45 UTC = 19:00..19:45 WIB
...
def main():
    ...
    lines = [
        "# ETH Economic-First E12G — 19:00–20:00 WIB LONG Character Discovery Result", "",
        f"Raw ETHUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **19:00–20:00 WIB only** (12:00, 12:15, 12:30, 12:45 UTC anchors).",
        "Scientific grammar and gates: **identical to preregistered E12A–E12F; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "ETH_ECONOMIC_FIRST_E12G_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "", "No 19:00–20:00 WIB LONG character passed the preregistered anchor-stability + pooled-economics + all-era gates.", "No gate relaxation and no OOS exposure.", "", "Research/shadow only."]
    ...
    status = "ETH_ECONOMIC_FIRST_E12G_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
