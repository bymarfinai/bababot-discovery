...
PFX = "BNB_ECONOMIC_FIRST_B28J_LONG_09_10WIB_CHARACTER"
...
CLOCKS = (120, 135, 150, 165)  # 02:00..02:45 UTC = 09:00..09:45 WIB
...
def main():
    ...
    lines = [
        "# BNB Economic-First B28J — 09:00–10:00 WIB LONG Character Discovery Result", "",
        f"Raw BNBUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **09:00–10:00 WIB only** (02:00, 02:15, 02:30, 02:45 UTC anchors).",
        "Methodology and gates: **identical to preregistered B28A–B28I; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "BNB_ECONOMIC_FIRST_B28J_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 09:00–10:00 WIB BNB LONG character passed the preregistered anchor-stability + pooled-economics/risk + all-era gates.",
                  "No gate relaxation, prior-hour rescue, B27 structural rescue, or OOS exposure is allowed.",
                  "Next preregistered habitat: **10:00–11:00 WIB** with the unchanged methodology.", "", "Research/shadow only."]
    ...
    status = "BNB_ECONOMIC_FIRST_B28J_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
