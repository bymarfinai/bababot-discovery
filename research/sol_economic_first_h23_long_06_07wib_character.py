#!/usr/bin/env python3
"""Preregistered H23 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H23_LONG_06_07WIB_CHARACTER"

engine.CLOCKS = (1380, 1395, 1410, 1425)
engine.PFX = PFX
...
def relabel_outputs() -> None:
    ...
    for old, new in (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H23 — 06:00–07:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "23:00–00:00 UTC / 06:00–07:00 WIB"),
        ("07:00–08:00 WIB", "06:00–07:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H23_"),
    ):
        result = result.replace(old, new)
    engine.OUT_RESULT.write_text(result)
    engine.OUT_STATUS.write_text(
        engine.OUT_STATUS.read_text().replace("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H23_")
    )
