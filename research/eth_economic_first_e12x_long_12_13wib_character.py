...
PFX = "ETH_ECONOMIC_FIRST_E12X_LONG_12_13WIB_CHARACTER"
...
def main():
    ...
    lines = [
        "# ETH Economic-First E12X — 12:00–13:00 WIB LONG Character Discovery Result", "",
        f"Raw ETHUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **12:00–13:00 WIB only** (05:00, 05:15, 05:30, 05:45 UTC anchors).",
        "Scientific grammar and gates: **identical to preregistered E12A–E12W; only the hour changed**.",
    ...
    if len(C) == 0:
        ...
        lines += ["", f"**Status: {status}**", "", "No 12:00–13:00 WIB LONG character passed the preregistered anchor-stability + pooled-economics + all-era gates.", "No gate relaxation and no OOS exposure.", "", "Research/shadow only."]
    ...
    status = "ETH_ECONOMIC_FIRST_E12X_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
