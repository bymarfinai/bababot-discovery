...
PFX = "BNB_ECONOMIC_FIRST_B28L_LONG_11_12WIB_CHARACTER"
...
CLOCKS = (240, 255, 270, 285)  # 04:00..04:45 UTC = 11:00..11:45 WIB
...
def main():
    ...
    lines = [
        "# BNB Economic-First B28L — 11:00–12:00 WIB LONG Character Discovery Result", "",
        f"Raw BNBUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **11:00–12:00 WIB only** (04:00, 04:15, 04:30, 04:45 UTC anchors).",
        "Methodology and gates: **identical to preregistered B28A–B28K; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "BNB_ECONOMIC_FIRST_B28L_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 11:00–12:00 WIB BNB LONG character passed the preregistered anchor-stability + pooled-economics/risk + all-era gates.",
                  "No gate relaxation, prior-hour rescue, B27 structural rescue, or OOS exposure is allowed.",
                  "Next preregistered habitat: **12:00–13:00 WIB** with the unchanged methodology.", "", "Research/shadow only."]
    ...
    status = "BNB_ECONOMIC_FIRST_B28L_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
