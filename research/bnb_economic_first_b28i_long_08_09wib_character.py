...
PFX = "BNB_ECONOMIC_FIRST_B28I_LONG_08_09WIB_CHARACTER"
...
def main():
    ...
    lines = [
        "# BNB Economic-First B28I — 08:00–09:00 WIB LONG Character Discovery Result", "",
        f"Raw BNBUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **08:00–09:00 WIB only** (01:00, 01:15, 01:30, 01:45 UTC anchors).",
        "Methodology and gates: **identical to preregistered B28A–B28H; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "BNB_ECONOMIC_FIRST_B28I_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 08:00–09:00 WIB BNB LONG character passed the preregistered anchor-stability + pooled-economics/risk + all-era gates.",
                  "No gate relaxation, prior-hour rescue, B27 structural rescue, or OOS exposure is allowed.",
                  "Next preregistered habitat: **09:00–10:00 WIB** with the unchanged methodology.", "", "Research/shadow only."]
    ...
    status = "BNB_ECONOMIC_FIRST_B28I_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
