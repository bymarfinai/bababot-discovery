#!/usr/bin/env python3
"""Preregistered H20 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H20_LONG_03_04WIB_CHARACTER"

engine.CLOCKS = (1200, 1215, 1230, 1245)
engine.PFX = PFX
...
def relabel_outputs() -> None:
    ...
    for old, new in (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H20 — 03:00–04:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "20:00–21:00 UTC / 03:00–04:00 WIB"),
        ("07:00–08:00 WIB", "03:00–04:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H20_"),
    ):
        result = result.replace(old, new)
    engine.OUT_RESULT.write_text(result)
    engine.OUT_STATUS.write_text(
        engine.OUT_STATUS.read_text().replace("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H20_")
    )
