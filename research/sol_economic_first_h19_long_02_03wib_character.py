#!/usr/bin/env python3
"""Preregistered H19 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H19_LONG_02_03WIB_CHARACTER"

engine.CLOCKS = (1140, 1155, 1170, 1185)
engine.PFX = PFX
...
def relabel_outputs() -> None:
    ...
    for old, new in (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H19 — 02:00–03:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "19:00–20:00 UTC / 02:00–03:00 WIB"),
        ("07:00–08:00 WIB", "02:00–03:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H19_"),
    ):
        result = result.replace(old, new)
    engine.OUT_RESULT.write_text(result)
    engine.OUT_STATUS.write_text(
        engine.OUT_STATUS.read_text().replace("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H19_")
    )
