...
PFX = "BNB_ECONOMIC_FIRST_B28C_LONG_02_03WIB_CHARACTER"
...
CLOCKS = (1140, 1155, 1170, 1185)  # 19:00..19:45 UTC = 02:00..02:45 WIB
...
def main():
    ...
    lines = [
        "# BNB Economic-First B28C — 02:00–03:00 WIB LONG Character Discovery Result", "",
        f"Raw BNBUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **02:00–03:00 WIB only** (19:00, 19:15, 19:30, 19:45 UTC anchors).",
        "Methodology and gates: **identical to preregistered B28A/B28B; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "BNB_ECONOMIC_FIRST_B28C_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 02:00–03:00 WIB BNB LONG character passed the preregistered anchor-stability + pooled-economics/risk + all-era gates.",
                  "No gate relaxation, prior-hour rescue, B27 structural rescue, or OOS exposure is allowed.",
                  "Next preregistered habitat: **03:00–04:00 WIB** with the unchanged methodology.", "", "Research/shadow only."]
    ...
    status = "BNB_ECONOMIC_FIRST_B28C_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
