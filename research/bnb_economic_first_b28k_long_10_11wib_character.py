...
PFX = "BNB_ECONOMIC_FIRST_B28K_LONG_10_11WIB_CHARACTER"
...
CLOCKS = (180, 195, 210, 225)  # 03:00..03:45 UTC = 10:00..10:45 WIB
...
def main():
    ...
    lines = [
        "# BNB Economic-First B28K — 10:00–11:00 WIB LONG Character Discovery Result", "",
        f"Raw BNBUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **10:00–11:00 WIB only** (03:00, 03:15, 03:30, 03:45 UTC anchors).",
        "Methodology and gates: **identical to preregistered B28A–B28J; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "BNB_ECONOMIC_FIRST_B28K_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 10:00–11:00 WIB BNB LONG character passed the preregistered anchor-stability + pooled-economics/risk + all-era gates.",
                  "No gate relaxation, prior-hour rescue, B27 structural rescue, or OOS exposure is allowed.",
                  "Next preregistered habitat: **11:00–12:00 WIB** with the unchanged methodology.", "", "Research/shadow only."]
    ...
    status = "BNB_ECONOMIC_FIRST_B28K_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
