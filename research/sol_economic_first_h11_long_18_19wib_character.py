#!/usr/bin/env python3
"""Preregistered H11 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H11_LONG_18_19WIB_CHARACTER"
...
def relabel_outputs() -> None:
    ...
    for old, new in (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H11 — 18:00–19:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "11:00–12:00 UTC / 18:00–19:00 WIB"),
        ("07:00–08:00 WIB", "18:00–19:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H11_"),
    ):
        result = result.replace(old, new)
    engine.OUT_RESULT.write_text(result)
    engine.OUT_STATUS.write_text(
        engine.OUT_STATUS.read_text().replace("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H11_")
    )
