...
PFX = "ETH_ECONOMIC_FIRST_E12V_LONG_10_11WIB_CHARACTER"
...
def main():
    ...
    lines = [
        "# ETH Economic-First E12V — 10:00–11:00 WIB LONG Character Discovery Result", "",
        f"Raw ETHUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **10:00–11:00 WIB only** (03:00, 03:15, 03:30, 03:45 UTC anchors).",
        "Scientific grammar and gates: **identical to preregistered E12A–E12U; only the hour changed**.",
    ...
    if len(C) == 0:
        ...
        lines += ["", f"**Status: {status}**", "", "No 10:00–11:00 WIB LONG character passed the preregistered anchor-stability + pooled-economics + all-era gates.", "No gate relaxation and no OOS exposure.", "", "Research/shadow only."]
    ...
    status = "ETH_ECONOMIC_FIRST_E12V_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
