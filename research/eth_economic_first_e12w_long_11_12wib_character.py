...
PFX = "ETH_ECONOMIC_FIRST_E12W_LONG_11_12WIB_CHARACTER"
...
def main():
    ...
    lines = [
        "# ETH Economic-First E12W — 11:00–12:00 WIB LONG Character Discovery Result", "",
        f"Raw ETHUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **11:00–12:00 WIB only** (04:00, 04:15, 04:30, 04:45 UTC anchors).",
        "Scientific grammar and gates: **identical to preregistered E12A–E12V; only the hour changed**.",
    ...
    if len(C) == 0:
        ...
        lines += ["", f"**Status: {status}**", "", "No 11:00–12:00 WIB LONG character passed the preregistered anchor-stability + pooled-economics + all-era gates.", "No gate relaxation and no OOS exposure.", "", "Research/shadow only."]
    ...
    status = "ETH_ECONOMIC_FIRST_E12W_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
