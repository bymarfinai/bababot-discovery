...
PFX = "BNB_ECONOMIC_FIRST_B28N_LONG_13_14WIB_CHARACTER"
...
CLOCKS = (360, 375, 390, 405)  # 06:00..06:45 UTC = 13:00..13:45 WIB
...
def main():
    ...
    lines = [
        "# BNB Economic-First B28N — 13:00–14:00 WIB LONG Character Discovery Result", "",
        f"Raw BNBUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **13:00–14:00 WIB only** (06:00, 06:15, 06:30, 06:45 UTC anchors).",
        "Methodology and gates: **identical to preregistered B28A–B28M; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "BNB_ECONOMIC_FIRST_B28N_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 13:00–14:00 WIB BNB LONG character passed the preregistered anchor-stability + pooled-economics/risk + all-era gates.",
                  "No gate relaxation, prior-hour rescue, B27 structural rescue, or OOS exposure is allowed.",
                  "Next preregistered habitat: **14:00–15:00 WIB** with the unchanged methodology.", "", "Research/shadow only."]
    ...
    status = "BNB_ECONOMIC_FIRST_B28N_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
