...
PFX = "BNB_ECONOMIC_FIRST_B28D_LONG_03_04WIB_CHARACTER"
...
CLOCKS = (1200, 1215, 1230, 1245)  # 20:00..20:45 UTC = 03:00..03:45 WIB
...
def main():
    ...
    lines = [
        "# BNB Economic-First B28D — 03:00–04:00 WIB LONG Character Discovery Result", "",
        f"Raw BNBUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **03:00–04:00 WIB only** (20:00, 20:15, 20:30, 20:45 UTC anchors).",
        "Methodology and gates: **identical to preregistered B28A/B28B/B28C; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "BNB_ECONOMIC_FIRST_B28D_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 03:00–04:00 WIB BNB LONG character passed the preregistered anchor-stability + pooled-economics/risk + all-era gates.",
                  "No gate relaxation, prior-hour rescue, B27 structural rescue, or OOS exposure is allowed.",
                  "Next preregistered habitat: **04:00–05:00 WIB** with the unchanged methodology.", "", "Research/shadow only."]
    ...
    status = "BNB_ECONOMIC_FIRST_B28D_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
