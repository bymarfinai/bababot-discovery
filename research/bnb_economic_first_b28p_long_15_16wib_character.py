...
PFX = "BNB_ECONOMIC_FIRST_B28P_LONG_15_16WIB_CHARACTER"
...
def main():
    ...
    lines = [
        "# BNB Economic-First B28P — 15:00–16:00 WIB LONG Character Discovery Result", "",
        f"Raw BNBUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **15:00–16:00 WIB only** (08:00, 08:15, 08:30, 08:45 UTC anchors).",
        "Methodology and gates: **identical to preregistered B28A–B28O; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "BNB_ECONOMIC_FIRST_B28P_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "",
                  "No 15:00–16:00 WIB BNB LONG character passed the preregistered anchor-stability + pooled-economics/risk + all-era gates.",
                  "No gate relaxation, prior-hour rescue, B27 structural rescue, or OOS exposure is allowed.",
                  "Next preregistered habitat: **16:00–17:00 WIB** with the unchanged methodology.", "", "Research/shadow only."]
    ...
    status = "BNB_ECONOMIC_FIRST_B28P_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
