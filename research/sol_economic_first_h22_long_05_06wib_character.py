#!/usr/bin/env python3
"""Preregistered H22 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H22_LONG_05_06WIB_CHARACTER"

engine.CLOCKS = (1320, 1335, 1350, 1365)
engine.PFX = PFX
...
def relabel_outputs() -> None:
    ...
    for old, new in (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H22 — 05:00–06:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "22:00–23:00 UTC / 05:00–06:00 WIB"),
        ("07:00–08:00 WIB", "05:00–06:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H22_"),
    ):
        result = result.replace(old, new)
    engine.OUT_RESULT.write_text(result)
    engine.OUT_STATUS.write_text(
        engine.OUT_STATUS.read_text().replace("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H22_")
    )
