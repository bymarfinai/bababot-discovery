...
PFX = "ETH_ECONOMIC_FIRST_E12I_LONG_21_22WIB_CHARACTER"
...
CLOCKS = (840, 855, 870, 885)  # 14:00..14:45 UTC = 21:00..21:45 WIB
...
def main():
    ...
    lines = [
        "# ETH Economic-First E12I — 21:00–22:00 WIB LONG Character Discovery Result", "",
        f"Raw ETHUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **21:00–22:00 WIB only** (14:00, 14:15, 14:30, 14:45 UTC anchors).",
        "Scientific grammar and gates: **identical to preregistered E12A–E12H; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "ETH_ECONOMIC_FIRST_E12I_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "", "No 21:00–22:00 WIB LONG character passed the preregistered anchor-stability + pooled-economics + all-era gates.", "No gate relaxation and no OOS exposure.", "", "Research/shadow only."]
    ...
    status = "ETH_ECONOMIC_FIRST_E12I_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
