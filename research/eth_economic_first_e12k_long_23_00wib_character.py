...
PFX = "ETH_ECONOMIC_FIRST_E12K_LONG_23_00WIB_CHARACTER"
...
CLOCKS = (960, 975, 990, 1005)  # 16:00..16:45 UTC = 23:00..23:45 WIB
...
def main():
    ...
    lines = [
        "# ETH Economic-First E12K — 23:00–00:00 WIB LONG Character Discovery Result", "",
        f"Raw ETHUSDT 5m coverage: **{coverage:.4%}**.",
        "Direction: **LONG only**.",
        "Time habitat: **23:00–00:00 WIB only** (16:00, 16:15, 16:30, 16:45 UTC anchors).",
        "Scientific grammar and gates: **identical to preregistered E12A–E12J; only the hour changed**.",
    ...
    if len(C) == 0:
        status = "ETH_ECONOMIC_FIRST_E12K_NO_LONG_CHARACTER"
        OUT_STATUS.write_text(status + "\n")
        lines += ["", f"**Status: {status}**", "", "No 23:00–00:00 WIB LONG character passed the preregistered anchor-stability + pooled-economics + all-era gates.", "No gate relaxation and no OOS exposure.", "", "Research/shadow only."]
    ...
    status = "ETH_ECONOMIC_FIRST_E12K_LONG_CHARACTER_FOUND"
    OUT_STATUS.write_text(status + "\n")
