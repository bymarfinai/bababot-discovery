...
def main():
    ...
    # Hard firewall: Stage A sees only 2022 bars.
        ...
        for lb in LOOKBACKS:
            for hold in HOLDS:
                ...
                eligible = bool(
                    ...
                    s["max_loss_streak"] <= 10 and halves_ok and pos_a >= 2
                )
                rows.append({
    ...
    lines = [
        "# ETH R3 H03 — Stage A 2022 Development Freeze", "",
    ...
    if len(E) == 0:
        status = "ETH_R3_H03_NO_2022_DEV_CANDIDATE"
        ...
        status = "ETH_R3_H03_2022_DEV_CANDIDATE_FROZEN"
        OUT_STATUS.write_text(status + "\n")
        lines += [
