#!/usr/bin/env python3
"""Preregistered H16 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H16_LONG_23_00WIB_CHARACTER"
...
def relabel_outputs() -> None:
    ...
    for old, new in (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H16 — 23:00–00:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "16:00–17:00 UTC / 23:00–00:00 WIB"),
        ("07:00–08:00 WIB", "23:00–00:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H16_"),
    ):
        result = result.replace(old, new)
    engine.OUT_RESULT.write_text(result)
    engine.OUT_STATUS.write_text(
        engine.OUT_STATUS.read_text().replace("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H16_")
    )
