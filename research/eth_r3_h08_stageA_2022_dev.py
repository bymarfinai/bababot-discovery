...
base.PFX = "ETH_R3_H08_STAGEA"
base.OUT_GRID = ROOT / "ETH_R3_H08_STAGEA_2022_DevGrid.csv"
base.OUT_LOCK = ROOT / "ETH_R3_H08_STAGEA_FrozenDevCandidate.csv"
base.OUT_RESULT = ROOT / "ETH_R3_H08_STAGEA_Result.md"
base.OUT_STATUS = ROOT / "ETH_R3_H08_STAGEA_Status.txt"
base.HOUR_WIB = 8
