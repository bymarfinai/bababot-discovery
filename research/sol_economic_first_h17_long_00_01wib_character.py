#!/usr/bin/env python3
"""Preregistered H17 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H17_LONG_00_01WIB_CHARACTER"

engine.CLOCKS = (1020, 1035, 1050, 1065)
engine.PFX = PFX
...
def relabel_outputs() -> None:
    ...
    for old, new in (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H17 — 00:00–01:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "17:00–18:00 UTC / 00:00–01:00 WIB"),
        ("07:00–08:00 WIB", "00:00–01:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H17_"),
    ):
        result = result.replace(old, new)
    engine.OUT_RESULT.write_text(result)
    engine.OUT_STATUS.write_text(
        engine.OUT_STATUS.read_text().replace("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H17_")
    )
