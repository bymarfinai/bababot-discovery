#!/usr/bin/env python3
"""Preregistered H09 adapter for the frozen SOL economic-first engine."""
...
PFX = "SOL_ECONOMIC_FIRST_H09_LONG_16_17WIB_CHARACTER"
...
def relabel_outputs() -> None:
    ...
    for old, new in (
        ("SOL Economic-First H00 — 07:00–08:00 WIB", "SOL Economic-First H09 — 16:00–17:00 WIB"),
        ("00:00–01:00 UTC / 07:00–08:00 WIB", "09:00–10:00 UTC / 16:00–17:00 WIB"),
        ("07:00–08:00 WIB", "16:00–17:00 WIB"),
        ("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H09_"),
    ):
        result = result.replace(old, new)
    engine.OUT_RESULT.write_text(result)
    engine.OUT_STATUS.write_text(
        engine.OUT_STATUS.read_text().replace("SOL_ECONOMIC_FIRST_H00_", "SOL_ECONOMIC_FIRST_H09_")
    )
